package com.hackerhank.exercises.myregex;
 ...
 * 23.45.22.32.
 * I.Am.not.an.ip
 * In this problem you will be provided strings containing any combination of ASCII characters. You have to write
 * a regular expression to find the valid IPs.
 *
...
public class MyRegex {
    ...
    String deZeroa255 = "(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])";

    String pattern = String.format("%s.%s.%s.%s", deZeroa255, deZeroa255, deZeroa255, deZeroa255);
